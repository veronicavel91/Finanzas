                ...
                <form id="FormFinanciamiento" class="form-horizontal">
                    ...
                    <div id = "myTabContent" class = "tab-content">
                       ...
                       <br>
                            ...
                            <div class="col-lg-4">
                                <select data-live-search="true" class="selectpicker show-menu-arrow"  data-size="10" data-width="100%" name="plaza" id="cboPlaza" data-bv-notempty data-bv-notempty-message="la plaza es requerida" onchange="busqueda()" data-bind="value: plaza,attr : {'disabled' : isDisabled}">
                            ...
                            <div class="col-lg-4" id="rowSoc">
                               <select data-live-search="true" class="selectpicker show-menu-arrow"  data-size="10" data-width="100%" name="sociedad" id="cboSociedad" onchange="busqueda_cliente()" onchange="busqueda_cliente()" data-bind="value: sociedad,attr : {'disabled' : isDisabled}"></select>
                            </div><!-- /row-soc -->
                    </div><!-- form-group  -->
                    <div class="form-group">
                        <div id="rowCliente">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-1" id="load_factura" data-bind="visible: isLoading"><img src="./images/ajax-loader.gif" alt=""></div>
                    </div><!-- form-group  -->
...
<!-- ko if: facturas().length > 0 -->  
   <div class="panel with-nav-tabs panel-primary">
                <div class="panel-heading clearfix">
                    <div class="pull-left">
                        <h1 class="panel-title"><h4 data-bind="text: facturaNombre"></h4></h1> <label class="btn btn-danger btn-xs" data-bind="click: borrarFactura" for=""><i class="fa fa-trash"></i></label>
                    </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="general-tab">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-lg-7">
                                    <textarea name="" class="form-control" id="" rows="1" data-bind="value: nombreFactura,attr : {'disabled' : isDisabled}"></textarea>
                                </div>
                        ...
                        <div class="tab-pane" id="cheques-tab">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <label class="btn btn-info pull-left addButton btn-sm" data-bind="click: agregarCheque" data-template="textbox"><i class="fa fa-money"></i>  Agregar cheque/abono</label>
  ...
  <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header modal-header-danger">
                ...
                <h3 class="modal-title" id="lineModalLabel"><i class="fa fa-money"></i>  abono/cheque/pago</h3>
            </div>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-lg-5">
                            <select name="pagadora" class="form-control" id="pagadora" data-bind="value: notaSeleccionada().pagadora">
                                 ...
                                 <option  value="5378">SERVICIOS GRANTT LEVEL SA DE CV</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="btn-group btn-group-justified" role="group" id="buttons_agrega_cheq" aria-label="group button">
                    ...
                    <div class="btn-group" role="group">
                        <button class="btn btn-info pull-right addButton"  data-template="textbox" id="guarda_cheque" data-bind ="click:$parent.nuevoAbono"><i class="fa fa-save"></i>  Guardar deposito</button>
                    </div>
                </div>
                <div id="btnok3" style="display:none;">
                     <button type="button" class="btn btn-default" onclick="aceptar()" role="button">Aceptar</button>
